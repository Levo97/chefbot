...
if (isset($_SESSION["id"]) && $_SESSION["tiltott"] != 1) {
    ...
    <div class="doboz">
        ...
        <form action="upload.php" method="post" enctype="multipart/form-data">
            ...
            <input type="text" id="nev" name="nev" maxlength="50" placeholder="Recept neve" pattern=".{3,}" required><br>
            ...
            <div id="hozzavalok" class="form-group">
                <div id="hozzavalo">
                    <select id="alapanyag" name="1" onchange="frissit(0)" class="form-control" required>
                        ...
                        ?></select><input type="number" min="0" step="0.01" name="2" class="form-control"
                                          id="mennyi"><select
            ...
            <h5>Egyéb adat:</h5>
            <textarea id="egyeb" name="egyeb" class="form-control" id="exampleFormControlTextarea1" rows="1" pattern=".{5,}"
                      placeholder="Ha a fenti mezőkben nem található a szükséges alapanyag/kategória, akkor itt rögzítheted és munkatársaink beszerzik őket. Fontos a recepthez használt mennyiség feltüntetése. PL: kategória: vegán alapanyag: 1.2 kg dió"></textarea>
