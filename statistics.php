...
<script type="text/javascript">
    ...
    function drawChart() {
        var data = google.visualization.arrayToDataTable([
            ['Kategoria', 'Recept']
            <?php    $query = "SELECT kategoria.neve as neve, COUNT(recept_id) as darab FROM kategoriak, kategoria where kategoriak.kategoria_id=kategoria.id GROUP by kategoria.neve  ";
...
<div id="chart_div3" style="width: 100%; height: 500px; display:inline-block; border-style: solid;  border-width: 7px; border-color: #818181;"></div>

<div id="chart_div" style="width: 100%; height: 500px; display:inline-block; border-style: solid;  border-width: 7px; border-color: #818181;"></div>

<div id="chart_div2" style="width: 100%; height: 500px; display:inline-block; border-style: solid;  border-width: 7px; border-color: #818181;"></div>

<div id="chart_div4" style="width: 100%; height: 500px; display:inline-block; border-style: solid;  border-width: 7px; border-color: #818181;"></div>
